    ...
    <>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full min-h-[600px] overflow-hidden md:flex-row">
       ...
       <div className="w-full md:w-64 bg-gray-50/50 border-r border-gray-100 p-6 flex flex-col gap-2">
           ...
           {[
              { id: 'vendors', label: t('Vendedores'), icon: <Users size={18}/> },
           ].map(tab => (
               <button 
                  key={tab.id}
           ...
           <div className="flex-1 max-w-3xl">
               ...
               {activeTab === 'vendors' && (
                   <div className="space-y-6 animate-fade-in">
                        <div>
                            <h4 className="text-xl font-bold text-gray-800 border-b border-gray-100 pb-2 mb-2">{t('Gestión de Vendedores')}</h4>
                            <p className="text-sm text-gray-500 mb-6">{t('Agrega vendedores por nombre. Se usarán para identificar quién realizó cada venta o reserva.')}</p>
                        </div>
